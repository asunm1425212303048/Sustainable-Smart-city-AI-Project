...
Original file is located at
    https://colab.research.google.com/drive/13G_TN2pRqTcz5fSNHWRZrbNa3bJ0QiBi
"""
...
def eco_tips_generator(problem_keywords):
    prompt = f"Generate practical and actionable eco-friendly tips for sustainable living related to: {problem_keywords}. Provide specific solutions and suggest improvements."
...
with gr.Blocks() as app:
    gr.Markdown("# Sustainable Smart City AI")
